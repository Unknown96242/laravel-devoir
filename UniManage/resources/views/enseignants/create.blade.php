    ...
    <main class="md:ml-72 min-h-screen transition-all duration-500">
        ...
        <header
            ...
            <div class="px-6 py-4 flex items-center justify-between">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h2 class="text-2xl font-display font-bold text-slate-900 dark:text-white">Nouvel Enseignant</h2>
                        <p class="text-sm text-slate-500 dark:text-slate-400 font-sans">Ajoutez un nouvel enseignant à la
                            base de données</p>
                    </div>
                </div>
        ...
        <div class="p-6">
            <div class="max-w-5xl mx-auto">
                <form class="space-y-6" method="POST" action="{{ route('enseignants.store') }}">
                    @csrf
                    ...
                    <div
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="form-group">
                                ...
                                <input name="prenom" id="prenom" type="text" placeholder="Ex: Moussa" value="{{ old('prenom') }}"
                            ...
                            <div class="form-group">
                                ...
                                <input name="nom" id="nom" type="text" placeholder="Ex: Diallo" value="{{ old('nom') }}"
                    ...
                    <div
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="form-group">
                                ...
                                <select name="grade" id="grade"
                                    ...
                                    <option value="professeur" {{ old('grade') == 'professeur' ? 'selected' : '' }}>
                                        Professeur</option>
                                    <option value="docteur" {{ old('grade') == 'docteur' ? 'selected' : '' }}>Docteur
                                    </option>
                                    <option value="maitre_conferences"
                                        {{ old('grade') == 'maitre_conferences' ? 'selected' : '' }}>Maître de
                                        conférences</option>
                            ...
                            <div class="form-group">
                                ...
                                <select name="departement" id="departement"
                                    ...
                                    <option value="informatique"
                                        {{ old('departement') == 'informatique' ? 'selected' : '' }}>Informatique</option>
                                    <option value="mathematiques"
                                        {{ old('departement') == 'mathematiques' ? 'selected' : '' }}>Mathématiques
                                    </option>
                                    <option value="physique" {{ old('departement') == 'physique' ? 'selected' : '' }}>
                                        Physique</option>
                                    <option value="chimie" {{ old('departement') == 'chimie' ? 'selected' : '' }}>Chimie
                                    </option>
                            ...
                            <div class="form-group md:col-span-2">
                                <div class="flex items-center space-x-4">
                                    <input type="checkbox" id="statut" name="statut" id="statut" value="1"
                                        {{ old('statut', true) ? 'checked' : '' }} class="peer hidden">
    ...
    @section('script')
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                toast.show('Enseignant enregistré avec succès');
            });
        </script>
